...
class LocationTrackingService : Service() {
    ...
    override fun onCreate() {
        ...
        try {
            ...
            Log.d(TAG, "location updated by network ......"+ locationManager!!.getLastKnownLocation(LocationManager.NETWORK_PROVIDER))
        ...
        try {
            ...
            Log.d(TAG, "location updated by GPS ......"+ locationManager!!.getLastKnownLocation(LocationManager.GPS_PROVIDER))
        } catch (e: SecurityException) {
            Log.e(TAG, "Fail to request location update", e)
        } catch (e: IllegalArgumentException) {
